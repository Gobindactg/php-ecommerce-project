...
/*if(isset($_POST['submit'])){
	...
	admin_login_check($_POST);
		...
		if(isset($_POST['submit'])){     
			...
			//$query = "SELECT * FROM admin_table WHERE user_email='$data[email_address]' AND user_pass ='$data[user_pass]' AND deletion_status= '1' ";
		...
		if($userEmail==  $name && $userPass== $password){
	    ...
	    <div class="register">
			   ...
			   <div class="col-md-6 login-right">
				...
				<form action="" method="post">
				  <div>
					 <h2 style="color:red; background-color:black"><?php  if(isset($message)){  echo $message; } ?></h2> 
