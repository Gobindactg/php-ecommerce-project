...
if(!$connection){
 ...
 if(isset($_POST['profile_update'])){
   ...
   /* if($img){
        ...
        if($file_name){
            $update_query = "UPDATE admin_table SET  user_name='$admin_name', user_email='$user_email', user_phone='$user_phone', user_pass='$user_pass', user_address='$user_address', user_about='$user_about', picture='$file_name' WHERE admin_id= $update_id";
        }
        else{
            $update_query = "UPDATE admin_table SET  user_name='$admin_name', user_email='$user_email', user_phone='$user_phone', user_pass='$user_pass', user_address='$user_address', user_about='$user_about' WHERE admin_id= $update_id";
        }
    }
