  ...
  <?php
  	if(isset($_GET['logout'])){
		...
		user_logout();
            ...
            $query = "SELECT * FROM blog_table WHERE blog_user = '$_SESSION[user_name]'";
...
<link rel="stylesheet" href="css/display_blog1.css">
     <div class="blog">
        ...
        <div class="blog_body">
         ...
         <a href="edit_blog.php?id=<?php echo $id ?>">edit</a> ||  <a href="delete_blog.php?id=<?php echo $id ?>">Delete</a>
         </div>
         <hr><hr>
         </div>
    </div>
