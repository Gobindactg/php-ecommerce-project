            ...
            <div class="wel">
                ...
                <table class="table table">
                    <thead>
                        <tr>
                            <td>
                              <a href="include/invoice2.php" class="btn btn-primary">Print</a>
                            </td>
                            <td>
                                <h3 class="text-right">Sender: TODAYSHOP </h3>
                                <h4 class="text-right" >Anower Complex, Mirsarai,</h4>
                                <h4 class="text-right" >Chattogram</h4>
                    ...
                    <thead>
                        <tr>
                            ...
                            <td>
                                ...
                                <h4 class="text-right" >Address : <?php echo $rows['address'];?></h4>
                                <h4 class="text-right" ><?php echo $rows['city'].' , '. $rows['country'];?></h4>
