...
<?php
$query_result = select_display_product_info();
$query_result_promotion = select_display_product_promotion();
$query_blog = select_display_blog();
?>
...
<div class="content_middle">
	<div class="container">
		<ul class="promote">
		 ...
		 <ul id="flexiselDemo3">
			 <?php while($rows = mysqli_fetch_assoc($query_result_promotion)) {?>
						<li><img style="height:200px;" src="admin/<?php echo $rows['product_image'];?>"  class="img-responsive" /><div class="grid-flex"><h4><?php echo $rows['product_name'];?> </h4><p>BDT <?php echo $rows['product_price'];?></p>
							<div class="m_3"><a href="single_product.php?product_id=<?php echo $rows['product_id'];?>" class="link2">Add to Cart</a></div>
   ...
   <div class="content_middle_bottom">
	  <div class="col-md-4">
		...
		<div class="col-md-8">
		  <ul class="spinner">
			<i class="paperclip"> </i>
			<li class="spinner_head"><h3>From the Blog || <button style="padding-left:10px"><a href="display_blog.php">All Blog </a></button></h3></li>
			<div class="clearfix"> </div>
		  </ul>
		  <?php while($rows = mysqli_fetch_assoc($query_blog)) {?>
		      <div class="a-top" >
				
				 <div class="grid" >
				 	<img style="height:150px" src="images/<?php echo $rows['blog_image'];?>" class="img-responsive" alt=""/>
					<h4 style="padding:5px 5px;"><a href="#" style="color:black; font-style:italic; font-family:tahoma, font-weight:900; padding:0px 0px"><?php echo $rows['title'];?></a></h4>
					<p > Posted by : <span style="color:green; font-family: tahoma; font-style: italic; font-size:15px;"> <?php echo $rows['blog_user'];?></span>   || <span>submited time: <?php echo $rows['s_date']; ?></span>  </p>
					<p style="text-align:justify; font-famity:tahoma;"><?php echo $rows['body'];?></p>
				 </div>
				 <div class="but">
