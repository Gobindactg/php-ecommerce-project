...
<body>
    <div class="container">
        ...
        <h3 style="text-align:center; color:black;"> Please Select Below Information for Exam Mark Entry</h3>
        
        <hr><hr>
       

     <form action="mark1.php" method="get">
        ...
        <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
                <select style="width: 90%;" name="class_group" id="" required>
