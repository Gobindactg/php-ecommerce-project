            ...
            <nav class="navbar navbar-expand-md navbar-light bg-faded">
                ...
                <div class="collapse navbar-collapse main-menu" id="navbarSupportedContent">
                    <ul class="navbar-nav nav lavalamp ml-auto menu">
                        ...
                        <li class="nav-item"><a href="admission2.php" class="nav-link">Admission</a></li>
                        ...
                        <li class="nav-item"><a href="course.php" class="nav-link">Courses</a>
                            <ul class="navbar-nav nav mx-auto">
                                ...
                                <li class="nav-item"><a href="course_details.php" class="nav-link">Courses Details</a></li>
                            </ul> 
                        </li>
                        <li class="nav-item"><a href="blog.php" class="nav-link">Blog</a>
                            <ul class="navbar-nav nav mx-auto">
                                <li class="nav-item"><a href="blog.php" class="nav-link">Create Blog</a></li> 
                                <li class="nav-item"><a href="blog-2.html" class="nav-link">Display Blog</a></li> 
                               
                            </ul> 
                        </li>
                        <li class="nav-item"><a href="#" class="nav-link">Pages</a>
                            <ul class="navbar-nav nav mx-auto">
                                <li class="nav-item"><a href="course.php" class="nav-link dropdown_icon">Courses</a>
                                    <ul class="navbar-nav nav mx-auto">
                                        <li class="nav-item"><a href="course.php" class="nav-link">Courses</a></li>
                                        <li class="nav-item"><a href="course_details.php" class="nav-link">Courses Details</a></li>
                                    </ul>    
                                </li>                                 
                                <li class="nav-item"><a href="event.php" class="nav-link dropdown_icon">Events</a>
                                    <ul class="navbar-nav nav mx-auto">
                                ...
                                <li class="nav-item"><a href="become_a_teacher.php" class="nav-link">Become A Teacher</a></li>
                                <li class="nav-item"><a href="teacher_profile.php" class="nav-link">Teachers Profile</a></li>
                                <li class="nav-item"><a href="team.php" class="nav-link">Teachers Page</a></li>
                                <li class="nav-item"><a href="forgot_password.php" class="nav-link">Forgot Password</a></li>
                            </ul>                            
                        </li>     
...
<?php 
    if(isset($bitm)){
        ...
        if($bitm == 'index3'){
            include "pages/index3.php";
        }
        
        if($bitm == 'index4'){
            include "pages/index4.php";
        }
        if($bitm == 'become_a_teacher'){
            include "pages/become_a_teacher.php";
        }
        if($bitm == 'teacher_profile'){
            include "pages/teacher_profile.php";
        }
        if($bitm == 'event_details'){
